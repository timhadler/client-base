...
function editAddressForm(i) {
    document.getElementById("addressEditPopup-" + i).style.display = "block";
    popup.style.width = popup.parentNode.parentElement.clientWidth.toString() + "px";
}

function editAddressCloseForm(i) {
    document.getElementById("addressEditPopup-" + i).style.display = "none";
}
...
function editClientCloseForm() {
    document.getElementById("cliFormPopup").style.display = "none";
    document.getElementById("overlay").style.visibility = "hidden";
}

// Edit Comments popup
function editCommentForm() {
    document.getElementById("commentEditPopup").style.display = "block";
}

function editCommentCloseForm() {
    document.getElementById("commentEditPopup").style.display = "none";
}

// Add date popup
function addDateForm() {
    document.getElementById("addCallPopup").style.display = "block";
    document.getElementById("overlay").style.visibility = "visible";
}

function addDateCloseForm() {
    document.getElementById("addCallPopup").style.display = "none";
    document.getElementById("overlay").style.visibility = "hidden";
}

// Edit date popup
function editDateForm(i) {
    document.getElementById("rDateEditPopup-" + i).style.display = "block";
    document.getElementById("overlay").style.visibility = "visible";
}

function editDateCloseForm(i) {
    document.getElementById("rDateEditPopup-" + i).style.display = "none";
    document.getElementById("overlay").style.visibility = "hidden";
}
...
function editContactForm(i) {
    document.getElementById("contactEditPopup-" + i).style.display = "block";
    popup.style.width = popup.parentNode.parentElement.clientWidth.toString() + "px";
}

function editContactCloseForm(i) {
    document.getElementById("contactEditPopup-" + i).style.display = "none";
}
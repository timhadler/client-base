...
exports.completeReminder = async function({
    ...
    try {
        ...
        // Increment reminder count unless reminder ignored
        ...
        // Set 'first_reminder_sent' field if this is the first reminder
...
// Used when recording a response to email or text
...
exports.deleteReminder = async function({ id, userId }) {
    ...
    try {
        ...
        const clientId = await reminderModels.deleteReminder(id, userId, connection);
